...
from pyyaml_future import __version__
from pyyaml_future.example import hello
...
app = typer.Typer(
    name="pyyaml-future",
    help="Use YAML 1.3 Features in PyYAML (YAML 1.1)",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]pyyaml-future[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the pyyaml-future package.",
    ),
):
